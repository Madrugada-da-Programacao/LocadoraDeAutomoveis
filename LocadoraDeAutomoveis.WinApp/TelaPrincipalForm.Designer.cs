namespace LocadoraDeAutomoveis.WinApp
{
	partial class TelaPrincipalForm
	{
		...
		private void InitializeComponent()
		{
			...
			// 
			cadastrosToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { aluguelMenuItem, automovelMenuItem, clienteMenuItem, condutorMenuItem, funcionarioMenuItem, grupoDeAutomoveisMenuItem, planoDeCobrancaMenuItem, taxasEServicosMenuItem, parceiroToolStripMenuItem });
